defmodule BattleshipWeb.GameLive.PrivateRoomComponent do
  ...
  def render(assigns) do
    ...
    <div class="animate-fade-in" id="private-room-component">
      ...
      <.btn click="multiplayer-choice" to="#private-room-component" class="mt-6 text-white p-2 rounded bg-teal-600 hover:bg-teal-500 font-bold transition-all ease-linear block mx-auto">Voltar</.btn>
    </div>
    """
  end
